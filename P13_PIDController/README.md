...
Firstly I tried to tune only P-controller to drive align a center of road.  
Secondly I tried to tune D-controller with tuned P-controller to drive well curve. Only P-controller is not enough to drive curving road.  
Then I added I-controller. But I felt it was hard because the integral of CTE increase easily so I multiply 0.001 to raw CTE value.